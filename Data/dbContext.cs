...
public class dbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Loan>().HasOne(b => b.Book).WithOne(lo => lo.Loan).HasForeignKey<Book>(b => b.Id);
        ...
        modelBuilder.Entity<Book>().HasData(
            new Book { Id = 1, AuthorId = 1, Title = "Crime and Punishment", Publisher = "DoguBatı", PublicationYear = new DateTime(2010, 1, 1), Genre = "Novel" },
            ...
            new Book { Id = 6, AuthorId = 6, Title = "The Catcher in the Rye", Publisher = "Simon & Schuster", PublicationYear = new DateTime(2014, 4, 30), Genre = "Coming of Age" }
        );
