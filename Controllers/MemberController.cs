...
namespace library_automation.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Address")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone,Address")] Member member)
        {
            if (id != member.Id)
            {
                return NotFound();
